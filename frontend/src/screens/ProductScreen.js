      ...
      {loading ? (
        ...
        <>
          ...
          <Row>
            <Col md={6}>
              <h2>評價</h2>
              {product.reviews.length === 0 && <Message>目前無評價</Message>}
              <ListGroup variant='flush'>
                    ...
                    <Form onSubmit={submitHandler}>
                      <Form.Group controlId='rating'>
                        ...
                        >
                          ...
                          <option value='2'>2 - 略遜</option>
                          <option value='3'>3 - 還行</option>
